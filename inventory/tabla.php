    ...
    $sql = $conn->query("select i.inventory_id inventory_id, f.film_id film_id, i.store_id store_id,i.last_update last_update 
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td id="id<?php echo $results->inventory_id; ?>" ><?php echo $results->inventory_id;
                                                                      ?></td>
                    <td id="film<?php echo $results->inventory_id; ?>" ><?php echo $results->film_id;
                                                                          ?></td>
                    <td id="store<?php echo $results->inventory_id; ?>" ><?php echo $results->store_id;
                                                                          ?></td>
                    <td id="lastUpdate<?php echo $results->inventory_id; ?>"><?php echo $results->last_update;
                                                                ?></td>  
                    <td>
                      <button type="button" id="editbtn" class="btn btn-primary btn-sm bi bi-pencil-square" value="<?php echo $results->inventory_id; ?>">
                        EDITAR
                      </button>
                    </td>
                    <td>
                      <button type="button" id="deletebtn" class="btn btn-danger btn-sm bi bi-pencil-square" value="<?php echo $results->inventory_id; ?>">
                        ELIMINAR
                      </button>
                    </td>
                  </tr>
